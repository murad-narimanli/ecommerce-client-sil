...
function Payment() {
  ...
  const handleSubmit = (e) => {
    ...
    client.post("http://localhost:3030/order", { infos: data , products: basket }).then(() => {
      Alert();
    });
  };
  ...
  return (
    <div className="container">
      ...
      <form onSubmit={handleSubmit} className="payment">
        ...
        <label>
          Kart
          <br />
          <input type="number" name ="card"required="required" onChange={handleChange} />
        </label>
        <br />
        <label>
          Rayon
          <br />
          <select type="text" name="region" required="required" onChange={handleChange}>
    ...
    <label>
      Ünvan
      <br />
      <input type="text" name="address" required="required" onChange={handleChange} />
    </label>
    <br />
    <label>
      Qeyd
